...
export default function NavbarEmpty() {
  ...
  return (
    <div className="max-w-screen mx-auto px-4 py-4 sm:py-10">
      <div className="flex flex-col justify-between items-center">
        <div className="flex flex-row">
          <Link href="/intro">
            <h1 className="font-semibold text-base sm:text-lg dark:text-gray-100">
              {userData.name}
            </h1>
            <p className="font-light text-gray-500 dark:text-gray-300 text-sm sm:text-base">
          ...
          <button
            ...
            type="button"
            className="w-10 h-10 p-3 rounded focus:outline-none ml-auto"
        ...
        >
          <div className="mt-2 space-y-2 sm:mt-0 sm:space-y-0 sm:space-x-2 flex flex-row items-center">
            <ul className="items-center justify-center space-y-5 md:flex md:space-x-4 md:space-y-0">
              <li className="text-gray-600 dark:text-gray-300">
                  <a href="/intro">Portfolio</a>
              </li>
              <li className="text-gray-600 dark:text-gray-300">
                  <a href={userData.resumeUrl}>Resume</a>
              </li>
            </ul>

            {/* <a
              href="/intro"
              className="text-base font-normal text-gray-600 dark:text-gray-300 sm:mr-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
